"""
Oil database and calculation logic
...
class SoapMath:
    """
    Implements the exact calculation logic
    """

    @staticmethod
    def calculate_lye(
        oils: dict, lye_type: str = "NaOH", koh_purity: float = 1.0
    ) -> float:
        """
